...
def game(scores):
    ...
    k_press1 = False
    k_press2 = False
    def targets(game_over, score_value):# Car 1 targets
        for i in range(150):
    ...
    while running:
        ...
        if not game_over:
            ...
            # targets
            game_over, score_value=targets(game_over, score_value)
